  ...
  return (
    <>
      ...
      <div style={{ padding: "13px" }}>
        ...
        <p>
          Welcome to <b> Smart-Tuition</b>.
        </p>
        <p>
          <b>Smart-Tuition</b> (“us”, “we”, or “our”) operates{" "}
          <b>smarttuition.co.in</b> (hereinafter referred to as <b>“Service”</b>
          ).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>smarttuition.co.in</b>,
        ...
        <p>
          <b>SERVICE</b> means the smarttuition.co.in website operated by
          Smart-Tuition.
        </p>
        <p>
        ...
        <p>Smart-Tuition uses the collected data for various purposes:</p>
        ...
        <p>
          Smart-Tuition will take all the steps reasonably necessary to ensure
        ...
        <p>
          ...
          <b>rajat.gupta.mart@gmail.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          us at <b>rajat.gupta.mart@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          by email: <b>rajat.gupta.mart@gmail.com</b>.
        </p>
      </div>
      <div>
        <Footer />
